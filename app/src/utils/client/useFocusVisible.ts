// Copied and adapted from pinterest/gestalt.
// https://github.com/pinterest/gestalt/blob/master/packages/gestalt/src/useFocusVisible.js
...
export default function useFocusVisible(): boolean {
